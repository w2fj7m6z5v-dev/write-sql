...
基本面收入来自最终版划小收入表 `dwm_srhx_serv_list_mon_final`，常用 `sum(fee_fm_new)`；按营服/包区/产品展开时可使用 `branch_id`、`branch_name`、`area_id`、`area_name`、`region_type`、`prod_id`、`prod_name`、`due_type`。
